...
static lv_style_t style_pie_indic;
...
static void basic_init() {
  ...
  lv_style_set_radius(&style_box, LV_STATE_DEFAULT, 0);
  ...
  lv_style_set_image_recolor_opa(&style_icon, LV_STATE_DEFAULT, LV_OPA_COVER); // Set opacity to full
  // lv_style_set_image_recolor(&style_icon, LV_STATE_DEFAULT, LV_COLOR_WHITE); // Set color to red
  ...
  // lv_style_set_line_rounded(&style_arc_indic, LV_STATE_DEFAULT, false);
  ...
  lv_style_set_line_rounded(&style_arc_bg, LV_STATE_DEFAULT, false);
  ...
  style_init_reset(&style_pie_indic);
  // lv_style_set_line_color(&style_pie_indic, LV_STATE_DEFAULT, Colors::lightGray);
  lv_style_set_line_width(&style_pie_indic, LV_STATE_DEFAULT, LV_DPX(25));
  // lv_style_set_line_width(&style_pie_indic, LV_STATE_DEFAULT, 1);
  // lv_style_set_line_rounded(&style_pie_indic, LV_STATE_DEFAULT, true);
  lv_style_set_line_rounded(&style_pie_indic, LV_STATE_DEFAULT, false);
  lv_style_set_bg_opa(&style_pie_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
...
lv_theme_t* lv_pinetime_theme_init() {
  ...
  theme.font_normal = &lv_font_montserrat_16;
  theme.font_subtitle = &lv_font_montserrat_16;
  theme.font_title = &lv_font_montserrat_16;
  theme.flags = 0;
...
static void theme_apply(lv_obj_t* obj, lv_theme_style_t name) {
  ...
  switch (name) {
    ...
    // case LV_THEME_PIE:
    //   lv_obj_clean_style_list(obj, LV_PIE_PART);
    //   list = lv_obj_get_style_list(obj, LV_PIE_PART);
    //   _lv_style_list_add_style(list, &style_pie_indic);
